    ...
    return (
        <div className="main">
            <div className='main one'>
                <Buttons patients={patients} setPatients={setPatients} workers={workers} setWorkers={setWorkers} notes={notes} setNotes={setNotes} documents={documents} setDocuments={setDocuments} />
                <Events />
