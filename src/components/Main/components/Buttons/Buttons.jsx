...
const Buttons = ({ documents, setDocuments, notes, setNotes, patients, setPatients, workers, setWorkers }) => {
    ...
    return (
        <div className="Buttons">
            ...
            {showModalWorker && <AddWorker workers={workers} setWorkers={setWorkers} close={handleModalCloseWorker} />}
        </div >
    )
}
